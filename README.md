...
* Fork this project. => create Spring Boot project
* Setup a decent build environment (Maven or Gradle). => create Spring Boot project
* Use Spring framework and Spring MVC in particular. Spring Boot recommended. create Spring boot project
